...
namespace TreinoDoRamon.Controllers
{
    public class EquipamentosController : Controller
    {
        ...
        public EquipamentosController(TreinoDoRamonContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EquipamentoId,Nome,Musculo,Imagem")] Equipamento equipamento)
        {
